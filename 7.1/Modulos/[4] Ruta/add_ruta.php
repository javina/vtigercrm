...
*/
        ...
        */        
                ...
                $geo_inicio  = new Vtiger_Field();
                $geo_inicio->name = 'geocercaid_inicio';
                $geo_inicio->label= 'LBL_MODULE_POPUP_GEOCERCA_INICIO';
                $geo_inicio->uitype= 10;                
                $geo_inicio->column = $geo_inicio->name;
                $geo_inicio->columntype = 'VARCHAR(255)';
                $geo_inicio->typeofdata = 'V~O';
                $block->addField($geo_inicio);
                $geo_inicio->setRelatedModules( Array(  'Geocerca' ));

                $geo_fin  = new Vtiger_Field();
                $geo_fin->name = 'geocercaid_fin';
                $geo_fin->label= 'LBL_MODULE_POPUP_GEOCERCA_FIN';
                $geo_fin->uitype= 10;                
                $geo_fin->column = $geo_fin->name;
                $geo_fin->columntype = 'VARCHAR(255)';
                $geo_fin->typeofdata = 'V~O';
                $block->addField($geo_fin);
                $geo_fin->setRelatedModules( Array(  'Geocerca' ));
        ...
        */        
                ...
                ->addField($geo_inicio, 1)                                
                ->addField($geo_fin, 2)                
                ->addField($account, 3)                                        
                ->addField($contact, 4)
                ->addField($description, 5)
